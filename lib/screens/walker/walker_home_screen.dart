                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 4,),
                                      Text('\$$todayEarnings', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 20),)
                                    ],
                                  ),
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 4,),
                                      Text('\$$weeklyEarnings', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 20),)
                                    ],
                                  ),
                                ]
                            ),
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text("Owner: ${data['ownerName'] ?? 'Unknown'}", style: const TextStyle(color: Colors.grey, fontSize: 14),),
                                          ],
                                        ),
                                      ),
                                      Column(
                        ...
                        return Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text("${data['petName']} - ${data['duration']} walk", style: const TextStyle(color: Colors.grey)),
